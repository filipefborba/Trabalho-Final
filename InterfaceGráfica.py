...
####   Telas:
    def  tela_inicial_frame(self):
        ...
        self.tela_inicial.rowconfigure(0, minsize=50, weight=1)
        self.tela_inicial.rowconfigure(1, minsize=50, weight=1)
        self.tela_inicial.rowconfigure(2, minsize=100, weight=1)
        self.tela_inicial.rowconfigure(3, minsize=100, weight=1)
        self.tela_inicial.rowconfigure(4, minsize=100, weight=1)
        self.tela_inicial.rowconfigure(5, minsize=100, weight=1)
        self.tela_inicial.rowconfigure(6, minsize=100, weight=1)
        self.tela_inicial.rowconfigure(7, minsize=100, weight=1)
        self.tela_inicial.rowconfigure(8, minsize=50, weight=1)
        self.tela_inicial.rowconfigure(9, minsize=50, weight=1)

        self.tela_inicial.columnconfigure(0, minsize=20, weight=1)
        self.tela_inicial.columnconfigure(1, minsize=200, weight=1)
        self.tela_inicial.columnconfigure(2, minsize=200, weight=1)
        self.tela_inicial.columnconfigure(3, minsize=200, weight=1)
        self.tela_inicial.columnconfigure(4, minsize=20, weight=1)
